function [Y,FS,NBITS,OPTS] = readMp3(FILE,N,MONO,DOWNSAMP,DELAY)
...
%
%   Note: requires external binaries mpg123 and mp3info; I have included
%   binary files with the package
%
%   See also mp3write, wavread.


% find our baseline directory
path = fileparts(which('readMp3'));
